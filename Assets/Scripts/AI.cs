...
public class AI : MonoBehaviour
{
    ...
    public TileManager.Tile nextTile;
    ...
    {
        // get current tile
        var currentPos = new Vector3(transform.position.x + 0.499f, transform.position.y + 0.499f);
    ...
    public void RunLogic()
    {
        ...
        if (nextTile.occupied || currentTile.isIntersection)
        {
            ...
            if (currentTile.isIntersection)
            {
                var availableTiles = new List<TileManager.Tile>();
                ...
                var rand = Random.Range(0, availableTiles.Count);
                chosenTile = availableTiles[rand];
                ghost.direction =
                    Vector3.Normalize(new Vector3(chosenTile.x - currentTile.x, chosenTile.y - currentTile.y, 0));
